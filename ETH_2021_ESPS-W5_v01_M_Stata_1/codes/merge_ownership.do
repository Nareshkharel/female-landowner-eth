...
logit fies_dummy sfi age age_sq basic_educ male_head dependency_ratio non_farm_enterprise  wealth_index female_landowner soil_fertility shock_faced married total_land livestock_hh dist_admhq dist_road i.saq01, vce(robust)
margins, dydx (*) post

outreg2 using spec_paper.doc, replace ctitle("FI")

logit fies_dummy sfi age age_sq basic_educ male_head dependency_ratio non_farm_enterprise  wealth_index sole_female_ownership joint_ownership soil_fertility shock_faced married total_land livestock_hh dist_admhq dist_road i.kebele, vce(robust)
margins, dydx (*) post

outreg2 using spec_paper.doc, append ctitle("FI")


logit severe_fi sfi age age_sq basic_educ male_head dependency_ratio non_farm_enterprise  wealth_index female_landowner soil_fertility shock_faced married total_land livestock_hh dist_admhq dist_road i.saq01, vce(robust)
margins, dydx (*) post

outreg2 using spec_paper.doc, append ctitle("Sev FI")
